...
<blockquote>🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://t.me/GamerBhai02'>Abu Talha Ansari</a></b></blockquote>"""
    

    ABOUT_TEXT = """<blockquote><b>‣ ᴍʏ ɴᴀᴍᴇ : All Movies Link Bot\n‣ ᴄʀᴇᴀᴛᴏʀ : <a href='https://t.me/GamerBhai02'>Abu Talha Ansari</a>\n‣ ʟɪʙʀᴀʀʏ : ᴘʏʀᴏɢʀᴀᴍ\n‣ ʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ\n‣ ᴅᴀᴛᴀ ʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ\n‣ ʜᴏsᴛᴇᴅ ᴏɴ  : ᴀʟʟ ᴡᴇʙ\n‣ ʙᴜɪʟᴅ sᴛᴀᴛᴜs : ᴠ3.1 [sᴛᴀʙʟᴇ]</b></blockquote>"""    
...
"""
    ...
    FILE_CAPTION = """<b>{file_name}\n\n𝖩𝗈𝗂𝗇➥ 「<a href="https://t.me/+QgSl55NlTiI0NDhl">All Movies Link</a>」</b>"""
...
3 ʀᴜᴘᴇᴇs ғᴏʀ 1 ᴅᴀʏ 👻
19 ʀᴜᴘᴇᴇs ғᴏʀ 7 ᴅᴀʏs 😐
69 ʀᴜᴘᴇᴇs ғᴏʀ 1 ᴍᴏɴᴛʜ 😚
129 ʀᴜᴘᴇᴇs ғᴏʀ 2 ᴍᴏɴᴛʜs 😗
299 ʀᴜᴘᴇᴇs ғᴏʀ 6 ᴍᴏɴᴛʜs 😚
459 ʀᴜᴘᴇᴇs ғᴏʀ 12 ᴍᴏɴᴛʜs 😚
...
🏷️ <a href='https://t.me/All_Movies__Premium_Proof'>ᴘʀᴇᴍɪᴜᴍ ᴘʀᴏᴏꜰ</a>
...
--------------Set Ads----------------
➩ /set_ads {ads name}}#{Times}#{photo URL} - <a href="https://t.me/GamerBhai02/11">Explain</a>
➩ /del_ads - Delete ads
-------------Top Trending------------
➩ /setlist {Mirzapur, Money Heist} - <a href=https://t.me/GamerBhai02/10>Explain</a>
...
--------------Verify On Off------------
/verifyoff {{verify.off code}} - off verification <a href="https://t.me/GamerBhai02">Cᴏɴᴛᴀᴄᴛ</a> ᴛʜᴇ ʙᴏᴛ ᴀᴅᴍɪɴ ғᴏʀ ᴀ ᴠᴇʀɪғʏ.ᴏғғ ᴄᴏᴅᴇ
/verifyon - on verification 
------------Set File Caption-----------
/set_caption - set coustom file caption 
-----------Set Imdb Template-----------
/set_template - set IMDb template <a href="https://t.me/GamerBhai02/8">Example</a>
--------------Set Tutorial-------------
...
Aᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴍᴀᴋᴇ ᴍᴇ ᴀᴅᴍɪɴ ᴀɴᴅ ᴜsᴇ ᴀʟʟ ғᴇᴀᴛᴜʀᴇs😇</b>"""
    ...
    SOURCE_TXT = """<b>
NOTE:
- ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ʜᴇʀᴇ ◉› :<blockquote><a href="https://github.com/GamerBhai02/AllMoviesLinkBot">All Movies Link Bot</a></blockquote>

Developer : Abu Talha Ansari
</b>""" 
...
Iғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ᴅᴏᴜʙᴛs ᴘʟᴇᴀsᴇ <a href="https://t.me/GamerBhai02">ᴄᴏɴᴛᴀᴄᴛ</a> ᴍʏ <a href="https://t.me/GamerBhai02">ᴀᴅᴍɪɴ</a></b>"""
